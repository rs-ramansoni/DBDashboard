...
CREATE SCHEMA IF NOT EXISTS `EMPLOYEEDB` DEFAULT CHARACTER SET latin1 ;
...
-- Table `EMPLOYEEDB`.`COST`

-- -----------------------------------------------------

DROP TABLE IF EXISTS `EMPLOYEEDB`.`COST` ;

 

CREATE TABLE IF NOT EXISTS `EMPLOYEEDB`.`COST` (
...
DROP TABLE IF EXISTS `EMPLOYEEDB`.`POSITION` ;
...
-- Table `EMPLOYEEDB`.`EMPLOYEE_TYPE`

-- -----------------------------------------------------

DROP TABLE IF EXISTS `EMPLOYEEDB`.`EMPLOYEE_TYPE` ;

 

CREATE TABLE IF NOT EXISTS `EMPLOYEEDB`.`EMPLOYEE_TYPE` (
...
-- Table `EMPLOYEEDB`.`TENURE`

-- -----------------------------------------------------

DROP TABLE IF EXISTS `EMPLOYEEDB`.`TENURE` ;

 

CREATE TABLE IF NOT EXISTS `EMPLOYEEDB`.`TENURE` (
...
-- Table `EMPLOYEEDB`.`TENURE_MAPPING`

-- -----------------------------------------------------

DROP TABLE IF EXISTS `EMPLOYEEDB`.`TENURE_MAPPING` ;

 

CREATE TABLE IF NOT EXISTS `EMPLOYEEDB`.`TENURE_MAPPING` (
