...
CREATE TABLE DEPARTMENT (
  ...
  INDEX FK_DEPT_DEPT_ID_idx (PARENT_ID ASC),
...
CREATE TABLE EMPLOYEE (
  ...
  EMPLOYEE_DB_ID INT(11) NOT NULL,
  ...
  INDEX FK_EMP_COST_idx (COST_ID ASC),

  INDEX FK_EMP_DEPT_idx (DEPT_ID ASC),

  INDEX FK_EMP_POS_idx (POSITION_ID ASC),

  INDEX FK_EMP_TEN_idx (TENURE_ID ASC),

  INDEX FK_EMP_LOC_idx (LOCATION_ID ASC),

  INDEX FK_EMP_JD_idx (JOINING_DATE ASC),

  INDEX FK_EMP_TYPE_idx (EMPLOYEE_TYPE_ID ASC),

  INDEX FK_EMP_ED (JOB_END_DATE ASC),
